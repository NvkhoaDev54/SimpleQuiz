                        ...
                        {[
                          ...
                          >
                            ...
                            <td className="p-4 text-right">
                              <button
                                className="text-text-secondary hover:text-white p-2 rounded hover:bg-[#3d4654] transition-colors"
                    ...
                    {[
                      ...
                      <div key={idx}>
                        <div className="flex gap-3">
                          <div
                            className={`mt-1 min-w-8 h-8 rounded-full bg-${item.color}-500/20 flex items-center justify-center text-${item.color}-500`}
                          >
